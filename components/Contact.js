            ...
            <div className={styles.main}>
                ...
                <div className={styles.main2}>
                    ...
                    <div className={styles.links}>
                        <a data-social="Linkedin" className={styles.linkedinButton} id={styles.linkBtn} href="https://www.linkedin.com/in/srinivas-batthula/" title="srinivas batthula linkedin socials" target="_blank">
                        ...
                        <a data-social="GitHub" className={styles.githubButton} id={styles.linkBtn} href="https://github.com/srinivas-batthula/" title="srinivas batthula github socials" target="_blank">
                        ...
                        <a data-social="LeetCode" className={styles.leetcodeButton} id={styles.linkBtn} href="https://leetcode.com/u/srinivas-batthula/" title="srinivas batthula leetcode socials" target="_blank">
                        ...
                        <a data-social="Instagram" className={styles.instagramButton} id={styles.linkBtn} href="https://www.instagram.com/srinivas_abhi8/" title="srinivas batthula instagram socials" target="_blank">
                        ...
                        <a data-social="Twitter" className={styles.twitterButton} id={styles.linkBtn} href="https://x.com/Abhi07082005/" title="srinivas batthula x twitter socials" target="_blank">
