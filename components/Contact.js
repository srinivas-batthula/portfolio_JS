            ...
            <div className={styles.main}>
                ...
                <div className={styles.main2}>
                    ...
                    <div className={styles.links}>
                        <a data-social="Linkedin" className={styles.linkedinButton} id={styles.linkBtn} href="https://www.linkedin.com/in/srinivas-batthula/" target="_blank">
                        ...
                        <a data-social="GitHub" className={styles.githubButton} id={styles.linkBtn} href="https://github.com/srinivas-batthula/" target="_blank">
                        ...
                        <a data-social="LeetCode" className={styles.leetcodeButton} id={styles.linkBtn} href="https://leetcode.com/u/srinivas-batthula/" target="_blank">
                        ...
                        <a data-social="Instagram" className={styles.instagramButton} id={styles.linkBtn} href="https://www.instagram.com/srinivas_abhi8/" target="_blank">
