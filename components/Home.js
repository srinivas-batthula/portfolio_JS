            ...
            <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignContent: 'center', justifyItems: 'center', alignItems: 'center' }}>
                ...
                <div className={styles.d1}>
                    ...
                    <div className={styles.d4}>
                        ...
                        <a href="https://leetcode.com/u/WRBRSO7OH6/" target="_blank" style={{ fontSize:'2.2rem', width:'2.2rem', height:'2.2rem', marginRight: '1rem', borderRadius: '30%' }} className={styles.link4}>
