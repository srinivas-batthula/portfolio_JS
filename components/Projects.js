...
function Card({ project }) {
    return (
        ...
        >
            <div >
                <Image src={ "https://srinivas-batthula.vercel.app" + project.imgUrl } alt={`${project.title} image`} width={500} height={300} loading="lazy" className='rounded-lg mb-3 w-full h-60' />
            </div>
